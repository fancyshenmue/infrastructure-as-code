...
resource "cloudflare_filter" "allow_specific_address" {
  ...
  expression  = "(ip.src in {10.0.0.2 10.0.0.3} and http.host in {\"demo2.com\" \"www.demo2.com\"})"
}
...
resource "cloudflare_filter" "allow_tw" {
  ...
  expression  = "(ip.geoip.country in {\"TW\"} and http.host in {\"demo2.com\" \"www.demo2.com\"})"
}
